...
## 4. If 9, say Hi!
Write a Bash script that displays ```Best School``` 10 times, but for the 9th iteration, displays ```Best School``` __and then__ ``Hi`` on a new line.
...
The file ```/etc/passwd``` has already been covered in a [previous project](https://github.com/MrGiddy/alx-system_engineering-devops/tree/main/0x02-shell_redirections) and you should be familiar with it. Today we will make up a story based on it.
...
* Download and commit the [apache-access.log file](https://intranet.alxswe.com/projects/251#task-1232) along with your answers files
```
